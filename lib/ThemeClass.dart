...
class ThemeClass {
  static ThemeData lightTheme = ThemeData(
    ...
    unselectedWidgetColor: const Color.fromRGBO(0, 0, 0, 0.87),
    ...
    ), colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color.fromARGB(236, 251, 145, 92)), bottomAppBarTheme: const BottomAppBarTheme(color: Color.fromARGB(236, 251, 145, 92)),
  );
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    unselectedWidgetColor: const Color.fromRGBO(255, 255, 255, 0.87),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        backgroundColor: MaterialStateProperty.all<Color>(
    ...
    ), colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color.fromRGBO(36, 37, 64, 1)), bottomAppBarTheme: const BottomAppBarTheme(color: Color.fromARGB(255, 145, 150, 190)),
  );
}
